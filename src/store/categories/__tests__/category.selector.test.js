...
describe("Category selector", () => {
  test("selectCategories should return the categoriesData", () => {
    const catoriesSlice = selectCategories(mockState);
    expect(catoriesSlice).toEqual(mockState.categories.categories);
  });
  ...
  test("selectCategoriesMap should convert the items array into th appropriate map", () => {
